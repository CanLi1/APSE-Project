...
def main():
    ...
    # m.register_logic_constraint(all_of=(air, steam, fuel))
    ...
    # Fuel reactor fixes
    m.units.fuel_reactor.T.setlb(900)
    m.units.fuel_reactor.T.setub(900)
    ...
    '''m.units.air_reactor.SolidsCirc = Constraint(expr = \
            ...
            m.units.air_reactor.y_SolidIn['FeO']) == 500)'''
