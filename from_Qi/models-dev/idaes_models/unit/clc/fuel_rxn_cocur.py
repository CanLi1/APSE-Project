...
@ProcBlock("FuelRxnCocur")
class _FuelRxnCocur(UnitModel):
    """
    Equilibrium Co-current Fuel Reactor Model
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(_FuelRxnCocur, self).__init__(*args, **kwargs)
    ...
    def _build_energy_balance(self):
        ...
        # enforce sum(y) = 1 at solid inlet
        # @equip.Constraint()
        # def y_sum(equip):
        #     return sum(b.y_SolidIn[j] for j in b.comps) == 1
