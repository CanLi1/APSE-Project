...
@ProcBlock("SteamRxnCocur")
class _SteamRxnCocur(UnitModel):

    """
    Equilibrium Co-current Steam Reactor Model
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(_SteamRxnCocur, self).__init__(*args, **kwargs)
    ...
    def _build_unit_vars(self):
        ...
        b.Hc = Var(b.comps, doc='Standard molar enthalpy of component in J/mol', bounds=(-1E12, 1E12))
    ...
    def _build_unit_constraints(self):
        ...
        # equip.No_O2_Rxn = Constraint(expr = b.y_GasIn['O2']*b.F['GasIn'] == b.y_GasOut['O2']*b.F['GasOut'])
    ...
    def do_init(self):
        ...
        b.y_SolidIn['FeO'] = 0.542 - 3e-5
        b.y_SolidIn['Fe'] = 0.458
        b.y_SolidIn['C'] = 1e-5
