...
@ProcBlock("FuelRxnCounter")
class _FuelRxnCounter(UnitModel):
    """
    Equilibrium Counter-current Fuel Reactor Model
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(_FuelRxnCounter, self).__init__(*args, **kwargs)
    ...
    def _build_unit_vars(self):
        b = self
        b.T = Var(doc='Fuel reactor temperature (K)', domain=NonNegativeReals)
        ...
        b.logYeqSolidout = Var(b.comps,
                               doc='Yeq at solid outlet for countercurrent\
                                    reactors')
        b.F = Var(b.k, doc='Fuel reactor molar flow rates in mol/s',
                  domain=NonNegativeReals)
        b.p = Var(b.k, b.comps, doc='Partial pressures',
                  domain=NonNegativeReals)
        b.Pt = Var(doc='Fuel reactor total pressure', domain=NonNegativeReals)
        b.Hc = Var(b.comps, doc='Standard molar enthalpy of component in J/mol')
        b.H = Var(b.k, doc='Enthalpy of stream in J/s')
        b.Q = Var(doc='Fuel reactor heat duty in J/s')
    ...
    def do_init(self):
        ...
        b.F['GasIn'] = 188.732 * 1000 / 3600
        b.F['SolidIn'] = 500

        # Example inlet conditions for fuel reactor
        b.y_GasIn['CH4'] = 0.973 - 3e-5
        b.y_GasIn['CO2'] = 0.013
        b.y_GasIn['CO'] =  1e-5
        b.y_GasIn['H2'] =  1e-5
        b.y_GasIn['H2O'] = 1e-5
        ...
        b.y_SolidIn['Fe2O3'] = 1 - 4e-5
        b.y_SolidIn['Fe3O4'] = 1e-5
        b.y_SolidIn['FeO'] = 1e-5
        b.y_SolidIn['Fe'] = 1e-5
        b.y_SolidIn['C'] = 1e-5
...
if __name__ == '__main__':
    ...
    m.units.fuel_reactor.solve(tee=True, options={'outlev': 5, 'tol': 1e-8})
