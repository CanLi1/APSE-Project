...
@ProcBlock("AirRxnCounter")
class _AirRxnCounter(UnitModel):
    """
    Equilibrium Counter-current Air Reactor Model
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(_AirRxnCounter, self).__init__(*args, **kwargs)
    ...
    def _build_unit_constraints(self):
        ...
        equip.EQ_rxn11_counter = Constraint(
            expr=b.EqConst['11', 'A'] + b.EqConst['11', 'B'] / b.T ==
            b.logYeq['CO2'] + 4 * b.logYeq['FeO'] - b.logYeqSolidout['C'] - 2 * b.logYeq['Fe2O3'])
        ...
        #equip.Cgetsoxidized = Constraint(expr = b.y_SolidOut['C'] == 0)
        ...
        equip.EQ_rxn11_counter.deactivate()        
        equip.EQ_rxn10_counter.deactivate()
        #equip.No_C_Rxn.deactivate()
    ...
    def do_init(self):
        ...
        # Example inlet conditions for a reactor
        b.y_GasIn['CH4'] = 0
        b.y_GasIn['CO2'] = 0
        b.y_GasIn['CO'] = 0
        b.y_GasIn['H2'] = 1e-5
        ...
        '''b.y_SolidIn['Fe2O3'] = 1e-5
        b.y_SolidIn['Fe3O4'] = 0.500 -3e-5
        b.y_SolidIn['FeO'] = 0.500
        b.y_SolidIn['Fe'] = 1e-5
        b.y_SolidIn['C'] = 1e-5'''
                   
        '''b.y_SolidIn['C'].fix(1.060331233e-08)
        b.y_SolidIn['FeO'].fix(0.7953853957)
        b.y_SolidIn['Fe2O3'].fix(0.026091295)
        b.y_SolidIn['Fe'].fix(0.0513790384)
        b.y_SolidIn['Fe3O4'].fix(0.12714425)'''
        
                   
        b.y_SolidIn['Fe2O3'] = (0.004705231)
        b.y_SolidIn['Fe3O4'] = (0.189593136)
        b.y_SolidIn['FeO'] = (0.77193468)
        b.y_SolidIn['Fe'] = (0.033490174)
        b.y_SolidIn['C'] = (0.000276778)
...
if __name__ == '__main__':
    ...
    m.units.air_reactor.solve(tee=True, options={'outlev': 5, 'tol': 1e-8})
