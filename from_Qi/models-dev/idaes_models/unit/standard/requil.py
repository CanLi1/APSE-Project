...
Inherits from rstoic and adds equilibrium constraints
"""
...
class UnitModel(rstoic.UnitModel):
    """
    Equilibrium Reactor Unit Class
    ...
    def _make_perform(self, b):
        ...
        # Constrain rates of reaction to be zero (equilibrium)
        def rule_x_rxn(blk, i):
            return 0 == blk.prop_out.rate_rxn[i]
