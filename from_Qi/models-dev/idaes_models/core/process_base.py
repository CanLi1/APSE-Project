...
#from .util.idjson import save_json, load_json old load/save json
from .util.idjson2 import load_json, save_json, StoreSpec, StoreSpecBounds
...
def ProcBlock(name):
    def ProcBlockDec(cls):
        c = type(
            name,
            (ProcessBlock,),
            {"_data_class":cls, "__module__":cls.__module__})
...
class CallableDict(dict):
    ...
    the same a a weakref to an indexed Pyomo var.  It helps with dealing with
...
class _IndexedProcessBlockMeta(type):
    ...
    def __new__(meta, name, bases, dct):
        ...
        def block_data_objects(self, *args, **kwargs):
            return itertools.chain(
                *[self[i].block_data_objects(*args, **kwargs) for i in self])
        dct["__init__"] = __init__
        dct["block_data_objects"] = block_data_objects
...
class ProcessBlock(Block):
    ...
    def save_json(self, *args, **kwargs):
        ...
        """
        return save_json(self, *args, **kwargs)
...
class ProcessBase(_BlockData):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs.setdefault("ctype", _BlockData)
        ...
        for vkey in c1.vars:
            ...
            if isinstance(v, pyomo.core.base.var.IndexedVar):
                ...
                try:
                    ...
                    raise("Pushing values along incompatible connetor")
    ...
    def strip_bounds(self):
        ...
        to bounds.
        """
        self.bstore = save_json(self, wts=StoreSpecBounds())
        blk = self
    ...
    def restore_bounds(self):
        load_json(self, sd=self.bstore, wts=StoreSpecBounds())
